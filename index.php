    ...
    <div class="container-fluid header bg-primary p-0 mb-5">
        <div class="row g-0 align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 p-5 wow fadeIn" data-wow-delay="0.1s">
                <h1 class="display-4 text-white mb-5">我們已經為您準備好了</br>永遠都是最新鮮的</h1>
                <div class="row g-4">
                    <div class="col-sm-4">
                ...
                <div class="owl-carousel header-carousel">
                    <div class="owl-carousel-item position-relative">
                        ...
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">專業，毋庸置疑</h1>
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="img/carousel-2.jpg" alt="">
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">快速，手起刀落</h1>
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="img/carousel-3.jpg" alt="">
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">不成功，直接送走</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h1 class="mb-4">有什麼理由必須選擇我們？</h1>
                    <p>我們所擁有的專業知識與技能是經過多年嚴格培訓和實踐磨練所獲得的。從基礎醫學知識到高難度的手術技巧，每一步都經過精心學習和實踐檢驗。我們的決策和操作影響著患者的生命安全，這是一份重大的責任。因此，我們的專業不容許被質疑。</p>
                    <p class="mb-4">每一次手術，我們都全力以赴，這是對我們的職業誓言和對患者信任的最高尊重。</p>
                    <p><i class="far fa-check-circle text-primary me-3"></i>苟延殘喘的身體</p>
                        ...
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="text-white mb-2">有經驗的</p>
                                        <h5 class="text-white mb-0">醫療團隊</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="text-white mb-2">品質保證的</p>
                                        <h5 class="text-white mb-0">服務</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="text-white mb-2">24 hr</p>
                                        <h5 class="text-white mb-0">線上支援</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
